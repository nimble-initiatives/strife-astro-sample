          ...
          <section>
            ...
            >
              <div class="relative  bg-black p-8 lg:p-20">
                <h2
                  class="mx-auto text-center text-3xl text-balance lg:text-8xl font-light font-display text-white "
                >
                  ${item?.heading}
                </h2>
                <form action="" class="mt-12">
                  <div class="flex w-full flex-col gap-1 sm:flex-row max-w-md mx-auto">
                    <input
                      name="email"
                      type="email"
...
customElements.define('section-list', Sections);
